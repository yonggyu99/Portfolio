  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-50 hidden md:block">
      ...
      <motion.div
        ...
        className="absolute bottom-6 right-6 flex gap-4 lg:hidden"
      >
        <a
      ...
      <motion.div
        animate={{ opacity: isContactVisible ? 0 : 1 }}
        transition={{ duration: 0.5, ease: 'easeInOut' }}
        className="absolute bottom-0 left-6 hidden lg:flex flex-col items-center"
      >
        <a
          href="https://github.com/yonggyu99"
          target="_blank"
      ...
      <motion.div
        animate={{ opacity: isContactVisible ? 0 : 1 }}
        transition={{ duration: 0.5, ease: 'easeInOut' }}
        className="absolute bottom-0 right-6 hidden lg:flex flex-col items-center"
      >
        <button
          onClick={handleEmailCopy}
