...
const ProjectCard = ({ project, isReversed = false }: ProjectCardProps) => {
    ...
    <div className="h-96 flex flex-col justify-between">
      <div>
        ...
        <div className="text-left mb-4">
          ...
          {/* 프로젝트 제목 */}
          <h3 className="text-primary text-3xl font-bold mb-2">{project.title}</h3>
        ...
        {/* 설명 박스 - 독립적인 박스 */}
        <div className="border border-secondary rounded-md p-6 mb-6">
      ...
      <div className="flex items-center justify-end gap-6">
        ...
        <a
          ...
          className="flex items-center justify-center w-12 h-12 border border-secondary rounded-full hover:bg-secondary hover:text-primary transition-all duration-300"
        >
        ...
        {/* 자세히 보기 버튼 */}
        <button
          className="px-6 py-3 border border-secondary text-secondary hover:bg-secondary hover:text-primary transition-all duration-300"
          onClick={() => {
            // 모달 오픈 로직 (나중에 구현)
  ...
  return (
    <div className={`flex gap-16 items-start ${isReversed ? 'flex-row-reverse' : ''}`}>
      {/* 왼쪽 콘텐츠 */}
